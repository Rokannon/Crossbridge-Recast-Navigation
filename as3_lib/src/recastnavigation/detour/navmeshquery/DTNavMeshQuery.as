package recastnavigation.detour.navmeshquery
{
	...
	public class DTNavMeshQuery extends RNBase
	{
		...
		public function findPath(startRef:int, endRef:int,
		...
		public function findStraightPath(startPosX:Number, startPosY:Number, startPosZ:Number,
										 endPosX:Number, endPosY:Number, endPosZ:Number,
		...
		public function findNearestPoly(centerX:Number, centerY:Number, centerZ:Number,
		...
		public function initSlicedFindPath(startRef:int, endRef:int,
										   startPosX:Number, startPosY:Number, startPosZ:Number,
										   endPosX:Number, endPosY:Number, endPosZ:Number,
		...
		public function queryPolygons(centerX:Number, centerY:Number, centerZ:Number,
									  extentsX:Number, extentsY:Number, extentsZ:Number,
									  filter:DTQueryFilter):int
		{
