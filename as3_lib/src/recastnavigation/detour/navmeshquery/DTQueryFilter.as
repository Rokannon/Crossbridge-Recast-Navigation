package recastnavigation.detour.navmeshquery {
	...
	public class DTQueryFilter extends RNBase {
		 ...
		 */
		public function getCost(paX:Number, paY:Number, paZ:Number, pbX:Number, pbY:Number, pbZ:Number, 
								prevRef:int, prevTile:DTMeshTile, prevPoly:DTPoly, 
								curRef:int, curTile:DTMeshTile, curPoly:DTPoly, 
			...
			var result:Number = internal_dtQueryFilter_getCost(
				ptr, pa_ptr, pb_ptr, 
				prevRef, prevTile.ptr, prevPoly.ptr, 
				curRef, curTile.ptr, curPoly.ptr, 
				nextRef, nextTile.ptr, nextPoly.ptr
			);
