package recastnavigation.detour.navmesh
{
    ...
    public class DTPoly extends RNBase
    {
        ...
        {
            return CModule.read32(ptr + OFFSET_FIRST_LINK);
        }

        public function set firstLink(value:int):void
        {
            CModule.write32(ptr + OFFSET_FIRST_LINK, value);
        }
        ...
        {
            return CModule.read16(ptr + OFFSET_VERTS + 2 * index);
        }
        ...
        {
            CModule.write16(ptr + OFFSET_VERTS + 2 * index, value);
        }

        /** Packed data representing neighbor polygons references and flags for each edge. Getter. */
        public function getNei(index:int):int
        {
            return CModule.read16(ptr + OFFSET_NEIS + 2 * index);
        }

        /** Packed data representing neighbor polygons references and flags for each edge. Setter. */
        public function setNei(index:int, value:int):void
        {
            CModule.write16(ptr + OFFSET_NEIS + 2 * index, value);
        }

        /** The user defined polygon flags. */
        public function get flags():int
        {
            return CModule.read16(ptr + OFFSET_FLAGS);
        }

        public function set flags(value:int):void
        {
            CModule.write16(ptr + OFFSET_FLAGS, value);
        }

        /** The number of vertices in the polygon. */
        public function get vertCount():int
        {
            return CModule.read8(ptr + OFFSET_VERT_COUNT);
        }

        public function set vertCount(value:int):void
        {
            CModule.write8(ptr + OFFSET_VERT_COUNT, value);
        }

        /** The bit packed area id and polygon type. */
        public function get areaAndtype():int
        {
            return CModule.read8(ptr + OFFSET_AREA_AND_TYPE);
        }

        public function set areaAndtype(value:int):void
        {
            CModule.write8(ptr + OFFSET_AREA_AND_TYPE, value);
        }

        /** Sets the user defined area id. [Limit: < #DT_MAX_AREAS] */
        public function setArea(a:int):void
        {
            internal_dtPoly_setArea(ptr, a);
        }

        /** Sets the polygon type. (See: #dtPolyTypes.) */
        public function setType(t:int):void
        {
            internal_dtPoly_setType(ptr, t);
        }

        /** Gets the user defined area id. */
        public function getArea():int
        {
            return internal_dtPoly_getArea(ptr);
        }

        /** Gets the polygon type. (See: #dtPolyTypes) */
        public function getType():int
        {
            return internal_dtPoly_getType(ptr);
        }
    }
}