package recastnavigation.detour.navmesh
{
    ...
    public class DTPolyDetail extends RNBase
    {
        ...
        {
            return CModule.read32(ptr + OFFSET_VERT_BASE);
        }

        public function set vertBase(value:int):void
        {
            CModule.write32(ptr + OFFSET_VERT_BASE, value);
        }

        /** The offset of the triangles in the dtMeshTile::detailTris array. */
        public function get triBase():int
        {
            return CModule.read32(ptr + OFFSET_TRI_VASE);
        }

        public function set triBase(value:int):void
        {
            CModule.write32(ptr + OFFSET_TRI_VASE, value);
        }
        ...
        public function get triCount():int
        {
            return CModule.read8(ptr + OFFSET_TRI_COUNT);
        }

        public function set triCount(value:int):void
        {
            CModule.write8(ptr + OFFSET_TRI_COUNT, value);
        }
    }
}