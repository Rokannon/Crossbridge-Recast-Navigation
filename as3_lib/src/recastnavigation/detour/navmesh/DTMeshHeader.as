package recastnavigation.detour.navmesh
{
    ...
    public class DTMeshHeader extends RNBase
    {
        ...
        {
            return CModule.read32(ptr + OFFSET_MAGIC);
        }

        public function set magic(value:int):void
        {
            CModule.write32(ptr + OFFSET_MAGIC, value);
        }

        /** Tile data format version number. */
        public function get version():int
        {
            return CModule.read32(ptr + OFFSET_VERSION);
        }

        public function set version(value:int):void
        {
            CModule.write32(ptr + OFFSET_VERSION, value);
        }
        ...
        {
            return CModule.read32(ptr + OFFSET_LAYER);
        }

        public function set layer(value:int):void
        {
            CModule.write32(ptr + OFFSET_LAYER, value);
        }
        ...
        {
            return CModule.read32(ptr + OFFSET_MAX_LINK_COUNT);
        }

        public function set maxLinkCount(value:int):void
        {
            CModule.write32(ptr + OFFSET_MAX_LINK_COUNT, value);
        }

        /** The number of sub-meshes in the detail mesh. */
        public function get detailMeshCount():int
        {
            return CModule.read32(ptr + OFFSET_DETAIL_MESH_COUNT);
        }

        public function set detailMeshCount(value:int):void
        {
            CModule.write32(ptr + OFFSET_DETAIL_MESH_COUNT, value);
        }

        /** The number of unique vertices in the detail mesh. (In addition to the polygon vertices.) */
        public function get detailVertCount():int
        {
            return CModule.read32(ptr + OFFSET_DETAIL_VERT_COUNT);
        }

        public function set detailVertCount(value:int):void
        {
            CModule.write32(ptr + OFFSET_DETAIL_VERT_COUNT, value);
        }
        ...
        {
            return CModule.read32(ptr + OFFSET_BV_NODE_COUNT);
        }

        public function set bvNodeCount(value:int):void
        {
            CModule.write32(ptr + OFFSET_BV_NODE_COUNT, value);
        }

        /** The number of off-mesh connections. */
        public function get offMeshConCount():int
        {
            return CModule.read32(ptr + OFFSET_OFFMESH_CON_COUNT);
        }

        public function set offMeshConCount(value:int):void
        {
            CModule.write32(ptr + OFFSET_OFFMESH_CON_COUNT, value);
        }

        /** The index of the first polygon which is an off-mesh connection. */
        public function get offMeshBase():int
        {
            return CModule.read32(ptr + OFFSET_OFFMESH_BASE);
        }

        public function set offMeshBase(value:int):void
        {
            CModule.write32(ptr + OFFSET_OFFMESH_BASE, value);
        }
        ...
        {
            return CModule.readFloat(ptr + OFFSET_BV_QUANT_FACTOR);
        }

        public function set bvQuantFactor(value:Number):void
        {
            CModule.writeFloat(ptr + OFFSET_BV_QUANT_FACTOR, value);
        }
    }
}