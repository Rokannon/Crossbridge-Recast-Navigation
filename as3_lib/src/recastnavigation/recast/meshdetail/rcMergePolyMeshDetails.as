package recastnavigation.recast.meshdetail {
	...
	import recastnavigation.internal_api.rcMergePolyMeshDetails;
	...
	public function rcMergePolyMeshDetails(ctx:RCContext, dmeshes:Vector.<RCPolyMeshDetail>, dmesh:RCPolyMeshDetail):Boolean {
		...
		var res:Boolean = recastnavigation.internal_api.rcMergePolyMeshDetails(ctx.ptr, dmeshes_ptr, nmeshes, dmesh.ptr);
