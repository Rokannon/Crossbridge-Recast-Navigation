package recastnavigation.recast.meshdetail {
	...
	import recastnavigation.internal_api.rcAllocPolyMeshDetail;
	import recastnavigation.internal_api.rcFreePolyMeshDetail;
	...
	public class RCPolyMeshDetail extends RNBase {
		...
		public function setMesh(index:int, value:int):void { return CModule.write32(CModule.read32(ptr + OFFSET_MESHES) + 4 * index, value); }
		...
		public function getTri(index:int):int { return CModule.read8(CModule.read32(ptr + OFFSET_TRIS) + 1 * index); }
		
		/** The mesh triangles. Setter. [Size: 4*#ntris] */
		public function setTri(index:int, value:int):void { CModule.write8(CModule.read32(ptr + OFFSET_TRIS) + 1 * index, value); }
		
		/** The number of sub-meshes defined by #meshes. */
		public function get nmeshes():int { return CModule.read32(ptr + OFFSET_NMESHES); }
		public function set nmeshes(value:int):void { CModule.write32(ptr + OFFSET_NMESHES, value); }
		...
		public function RCPolyMeshDetail() {
		...
		public override function alloc():void {
			...
			ptr = recastnavigation.internal_api.rcAllocPolyMeshDetail();
			
		}
		
		public override function free():void {
			
			recastnavigation.internal_api.rcFreePolyMeshDetail(ptr);
			ptr = 0;
