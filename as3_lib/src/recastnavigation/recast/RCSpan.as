package recastnavigation.recast
{
	...
	public class RCSpan extends RNBase
	{
		...
		public function set smin(value:int):void { CModule.write32(ptr + OFFSET_UNION, writeBits(CModule.read32(ptr + OFFSET_UNION), 0, 13, value)); }

		/** The upper limit of the span. [Limit: <= #RC_SPAN_MAX_HEIGHT] */
		public function get smax():int { return readBits(CModule.read32(ptr + OFFSET_UNION), 13, 13); }
		public function set smax(value:int):void { CModule.write32(ptr + OFFSET_UNION, writeBits(CModule.read32(ptr + OFFSET_UNION), 13, 13, value)); }

		/** The area id assigned to the span. */
		public function get area():int { return readBits(CModule.read32(ptr + OFFSET_UNION), 26, 6); }
		public function set area(value:int):void { CModule.write32(ptr + OFFSET_UNION, writeBits(CModule.read32(ptr + OFFSET_UNION), 26, 6, value)); }
