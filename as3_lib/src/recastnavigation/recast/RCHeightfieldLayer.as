package recastnavigation.recast
{
	...
	public class RCHeightfieldLayer extends RNBase
	{
		...
		public function get minx():int { return CModule.read32(ptr + OFFSET_MINX); }
		public function set minx(value:int):void { CModule.write32(ptr + OFFSET_MINX, value); }

		/** The maximum x-bounds of usable data. */
		public function get maxx():int { return CModule.read32(ptr + OFFSET_MAXX); }
		public function set maxx(value:int):void { CModule.write32(ptr + OFFSET_MAXX, value); }

		/** The minimum y-bounds of usable data. (Along the z-axis.) */
		public function get miny():int { return CModule.read32(ptr + OFFSET_MINY); }
		public function set miny(value:int):void { CModule.write32(ptr + OFFSET_MINY, value); }

		/** The maximum y-bounds of usable data. (Along the z-axis.) */
		public function get maxy():int { return CModule.read32(ptr + OFFSET_MAXY); }
		public function set maxy(value:int):void { CModule.write32(ptr + OFFSET_MAXY, value); }

		/** The minimum height bounds of usable data. (Along the y-axis.) */
		public function get hmin():int { return CModule.read32(ptr + OFFSET_HMIN); }
		public function set hmin(value:int):void { CModule.write32(ptr + OFFSET_HMIN, value); }

		/** The maximum height bounds of usable data. (Along the y-axis.) */
		public function get hmax():int { return CModule.read32(ptr + OFFSET_HMAX); }
		public function set hmax(value:int):void { CModule.write32(ptr + OFFSET_HMAX, value); }

		/** The heightfield. Getter. [Size: width * height] */
		public function getHeight(index:int):int { return CModule.read8(CModule.read32(ptr + OFFSET_HEIGHTS) + 1 * index); }

		/** The heightfield. Setter. [Size: width * height] */
		public function setHeight(index:int, value:int):void { CModule.write8(CModule.read32(ptr + OFFSET_HEIGHTS) + 1 * index, value); }
		...
		public function getCon(index:int):int { return CModule.read8(CModule.read32(ptr + OFFSET_CONS) + 1 * index); }

		/** Packed neighbor connection information. Setter. [Size: Same as #heights] */
		public function setCon(index:int, value:int):void { CModule.write8(CModule.read32(ptr + OFFSET_CONS) + 1 * index, value); }
	}
}